...
ADD FOREIGN KEY ("sales_order_id") REFERENCES "sales_order" ("id");
ALTER TABLE "sales_order_item"
ADD FOREIGN KEY ("product_id") REFERENCES "product" ("id");
ALTER TABLE "product_bundle"
ADD FOREIGN KEY ("bundle_product_id") REFERENCES "product" ("id");
ALTER TABLE "product_bundle"
ADD FOREIGN KEY ("component_product_id") REFERENCES "product" ("id");
-- Add threshold 
ALTER TABLE "inventory"
ADD COLUMN "threshold" INT DEFAULT 0;
-- connect supplier to product 
ALTER TABLE "product"
